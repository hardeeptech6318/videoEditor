...
export default function ColorPicker({onvalueChange}:{onvalueChange:(e:string)=>void}) {
  ...
  return (
    <div
      ...
      style={{ background }}
    >
      <GradientPicker background={background} setBackground={(e)=>{setBackground(e);onvalueChange(e)}} />
    </div>
  )
}
